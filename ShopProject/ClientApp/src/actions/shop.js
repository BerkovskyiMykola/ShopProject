...
export const editShop = (shopId, name, address, type) => (dispatch) => {
    return shopService.editShop(shopId, name, address, type).then(
        (responce) => {
            dispatch({
                type: EDIT_SHOP_SUCCESS,
                payload: { shopId, name, address, type }
            });
...
export const createShop = (name, address, type) => (dispatch) => {
    return shopService.createShop(name, address, type).then(
        (responce) => {
            dispatch({
